...
contract ERC20MintableSupplyToken03 {
address owner;


string public constant name = "Thomas Shelby";      // Token name 
string public constant TokenSymbol = "TS";      // TokenSymbol ID
uint public TotalAllowedSupply = 100000000000000000000;        // TotalAllowedSupply
